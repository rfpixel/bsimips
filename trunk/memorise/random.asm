...
# Procedimento que gera números aleatórios e os armazena na memória (no label 			# random_numbers).
.macro generate_random_numbers($target, $length, $max)
	la $t0, $target # ponteiro para o array na memória.
	lw $t1, $length # contador para o loop.

	loop_random:
		# id do gerador de números randômicos definido na subrotina set_seed.
		li $a0, 1 
		lw $a1, $max # o valor limite para o intervalo.  
